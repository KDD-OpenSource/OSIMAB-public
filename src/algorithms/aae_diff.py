...
class AdversarialAutoEncoderDiff(AdversarialAutoEncoder):
    def __init__(self, name: str = 'AdverserialAutoEncoderDiff',
        ...
        AdversarialAutoEncoder.__init__(self, name, num_epochs, batch_size, lr, hidden_size, sequence_length,
                                        train_gaussian_percentage, seed, gpu, details, activation)
